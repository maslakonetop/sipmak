...
<body>
    <div class="container-fluid"><br/><br/><br/><br/>
        <form method="POST" action="data/proses_edit.php">
        <section class="base">
        <h2 class="title text-center">Pembayaran Atas Nama <?php echo $data['nama_pemohon']?> (<?php echo $data['nobuku_plat']?>)</h2>
                <div class="row">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="nobuku_plat" value="<?php echo $data['nobuku_plat']; ?>"  />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lname" class="col-sm-6 col-form-label">Nama Jenazah</label>
                            <div class="col-sm-6">
                                <input type="text" name="nama_jenazah" class="form-control" id="lname" required="" value="<?php echo $data['nama_jenazah']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="lokasi_makam" required=""value="<?php echo $data['lokasi_makam']; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="biaya" required="" value="Rp <?php echo number_format($data['biaya'],0,',','.'); ?>" />    
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-sm-6 col-form-label">Ijin Berlaku</label>
                                <div class="col-sm-6">
                                <input type="text" class="form-control" name="ijin_berlaku" required=""value="<?php echo $data['ijin_berlaku']; ?>" />
                                </div>                 
                        </div>
                    </div>                       
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="nama_pemohon" class="form-control" id="fname" value="<?php echo $data['nama_pemohon']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-sm-6 col-form-label">NIK Pemohon</label>
                            <div class="col-sm-6">
                                <input type="text" name="nik" class="form-control" id="fname" value="<?php echo $data['NIK']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="usia_jenazah" class="form-control" id="lname" value="<?php echo $data['usia_jenazah']; ?>">
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            <label for="keterangan" class="col-sm-6 col-form-label">Metode Pembayaran</label>
                                ...
                                <div class="col-sm-6">
                                    <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="metode_pembayaran">
